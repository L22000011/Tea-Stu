...
class feature_extrator(nn.Module):
    ...
    def _freeze_all_backbones(self):
        ...
        self._freeze_module(self.csi_extractor)
    ...
    def forward(self, vk_data, depth_data, mmwave_data, lidar_data, csi_data, modality_list):
...
class X_Fi(nn.Module):
    ...
    def forward(self, vk_data, depth_data, mmwave_data, lidar_data, csi_data, modality_list):
        feature_list = self.feature_extractor(vk_data, depth_data, mmwave_data, lidar_data, csi_data, modality_list)
