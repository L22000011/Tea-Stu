...
from baseline_model import dual_model, quadra_model, single_model, triple_model
...
def train(model, train_loader, test_loader, num_epochs, learning_rate, criterion, device, modality, save_dir):
...
def main():
    parser = argparse.ArgumentParser('Official-style X-Fi HAR baseline1 with VK')
